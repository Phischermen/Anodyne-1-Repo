...
public static var briar:Object =
{
	GO: {
		before_fight: {
			dialogue: new Array(
				"Wayne: I’m tired, Jon.  I’m tired of all of these cycles.  I feel like I’m living the same dream, the same nightmare over and over again.",
				"Wayne: ...",
				"Wayne: It’s not going to change, Jon.  This is all we’ll ever be.")
		}
,
		after_fight: {
			dialogue: new Array(
...
,
		posthappy_mitra: {
			dialogue: new Array(
				...
				"I don’t know what you need to do to help Wayne.  I don’t understand how this world works or why everything seems so strange.  But I do want to be your friend, Jon.",
...
public static var happy_npc:Object =
{
	HAPPY: {
		beautiful: {
			dialogue: new Array(
				"You did it, Jon!  You defeated The Home Depot!  Look at this place!  It’s beautiful!",
				"So beautiful...")
		}
,
		dump: {
	...
	BLUE: {
		one: {
			dialogue: new Array(
				...
				"Annnd presto!",
				"Keep going, Jon, we’ve got your back!")
		}
	}
	,
	FIELDS: {
...
public static var sun_guy:Object =
{
	BEDROOM: {
		before_fight: {
			dialogue: new Array(
				"Oh, isn’t it cute?  Precious little Jon, playing the hero.  But I have witnessed every step you have taken in “The Land”, and let me tell you, Jon, not everyone here is as honest as me.  Be careful who you trust!")
		}
,
		after_fight: {
			dialogue: new Array(
				"I will be with you, Jon, whenever you are alone.  And remember my advice on your little “adventure”.")
		}
	}
};
...
,
		randoms: {
			dialogue: new Array(
				"Miao: Hey, Jon… have you ever stolen anything?",
				"Miao: I like James... and isn’t Wares a handsome bike?",
				"Miao: What’s that cool stone thing, Jon?  Does it make you go back in time?!",
				"Miao: I’m starting to get worried about Icky... Jon, have you seen a bigger cat around recently? Icky last said he was going to walk around the small forest to the east.",
				"Miao: Icky said I shouldn’t go where it's unsafe. I’ll see you later, Jon.",
				"Miao: Have you ever sat in a bunch of grocery bags?",
				"Miao: Hey Jon, do you think it’s wrong to do catnip?",
	...
	BLUE: {
		one: {
			dialogue: new Array(
				...
				"You know, Jon, friendship is just a trick people play on themselves.  We’re all assholes, and in the end, we’re all alone.",
...
,
		bush: {
			dialogue: new Array(
				"Rank: Eheheh, silly Jon! A broom’s no tool for cutting bushes!")
		}
,
		quest_normal: {
			dialogue: new Array(
